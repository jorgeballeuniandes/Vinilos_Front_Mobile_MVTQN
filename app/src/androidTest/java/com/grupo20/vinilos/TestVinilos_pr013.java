...
public class TestVinilos_pr013 {
    ...
    public void mainActivityTest() throws InterruptedException {
        ...
        Thread.sleep(1000);
        ViewInteraction albumTitle = onView((allOf(withId(R.id.album_view_title), withText("Album Info"), isDisplayed())));
        albumTitle.check(matches(isDisplayed()));
    }
