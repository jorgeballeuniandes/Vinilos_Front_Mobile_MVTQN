...
public class TestVinilos_pr014 {
    ...
    public void mainActivityTest2() throws InterruptedException {
        ...
        Thread.sleep(3000);
        ViewInteraction albumInfoTitle = onView((allOf(withId(R.id.txt_album_name), withText("OK Computer"), isDisplayed())));
        albumInfoTitle.check(matches(isDisplayed()));
    }
}